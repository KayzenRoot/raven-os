...
| M04 | Raven bootc base image + QCOW2 build path | 12 | `Containerfile`; `os/image-source.toml`; `scripts/build_*.py` | M01 | BLOCKED | Layer A present; Layer B needs Raven Builder. |
